...
const { typeOf, instOf, isArray, hasOwn, isBinary, hasBinary } = require("./common");
...
const isValidPayload = (type, payload) => {
    switch (type) {
